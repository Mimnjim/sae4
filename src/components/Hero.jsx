...
//     // Oscillation infinie du scroll down pour attirer l'attention
//     const floatingAnim = gsap.to(scrollDownRef.current, {
//         y: 10,
//         duration: 0.8,
//         repeat: -1,
//         yoyo: true,
//         ease: "sine.inOut",
//         overwrite: "auto" // Permet à la timeline de prendre le dessus sans conflit
//     });
...
//             y: -50, 
//             duration: 1,
//             onStart: () => floatingAnim.pause() // On stop le flottement dès qu'on scroll
//         }, 0);

//         tl.to([sloganRef.current, buttonsRef.current, footerHeroRef.current], { opacity: 0, y: -50, duration: 1 }, 0);
...
export default function Hero({ title1, title2, subtitle }) {
    ...
    const buildTimeline = useCallback(() => {
        ...
        tl.to(transitionRef.current, {
            opacity: 0.12,  // ← Très léger, juste une teinte
            pointerEvents: 'none',
            duration: 2,
            ease: 'power2.inOut',
        }, 9.5);
        ...
        ScrollTrigger.create({
            ...
            onLeaveBack: () => {
                gsap.set(transitionRef.current, { opacity: 0.12, pointerEvents: 'none' });
            }
        });
